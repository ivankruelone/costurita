...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function abonos($id)
    {
        ...
        <td align=\"right\" id=\"abonado\">".number_format($importe, 2)."</td>
        </tr>
        </tfoot
        </table>
          <script language=\"javascript\" type=\"text/javascript\">
...
/////////////////////
    ...
    function venta($fecha1, $fecha2)
    {
        ...
        $this->db->where("id_status in (3, 4) and date(fecha_alta) between '$fecha1' and '$fecha2'", '', false);
    ...
    order by o.id;";
        ...
        $query = $this->db->query($sql, array($this->input->post('fecha_inicial'), $this->input->post('fecha_final')));
        
        $tabla= "
        <h1>".TITULO_WEB."</h1>
        <h1>Reporte de Caja del ".$this->input->post('fecha_inicial')." al ".$this->input->post('fecha_final')."</h1>
        <table id=\"hor-minimalist-b\">
        <caption>Mostrando ".$query->num_rows()." Resultados</caption>
        <thead>
        ...
        <td align=\"right\">".number_format($this->venta($this->input->post('fecha_inicial'), $this->input->post('fecha_final')), 2)."</td>
        </tr>
        ...
        $tabla.= anchor('recepcion/caja_excel/'.$this->input->post('fecha_inicial').'/'.$this->input->post('fecha_final'), 'Bajarlo a excel');
...
order by o.id;";
        ...
        <h1>Reporte de Venta del <span id=\"fecha1\">".$this->input->post('fecha_inicial')."</span> al <span id=\"fecha2\">".$this->input->post('fecha_final')."</span></h1>
        <table id=\"hor-minimalist-b\">
        <caption>Mostrando ".$query->num_rows()." Resultados, Status: <span id=\"status_reporte\">$estatus</span></caption>
        <thead>
        ...
        $tabla.= anchor('recepcion/ventas_excel/'.$this->input->post('fecha_inicial').'/'.$this->input->post('fecha_final').'/'.$estatus, 'Bajarlo a excel');
    ...
    order by o.id;";
        ...
        $tabla= "
        <h1>".TITULO_WEB."</h1>
        <h1>Reporte de Venta del ".$this->input->post('fecha_inicial')." al ".$this->input->post('fecha_final')."</h1>
        <table id=\"hor-minimalist-b\">
        <caption>Mostrando ".$query->num_rows()." Resultados</caption>
        <thead>
        ...
        $tabla.= anchor('recepcion/auditoria_excel/'.$this->input->post('fecha_inicial').'/'.$this->input->post('fecha_final').'/'.$estatus.'/'.$usuario, 'Bajarlo a excel');
...
and date(fecha_cancelacion) between ? and ?;";
        ...
        $tabla= "
        <h1>".TITULO_WEB."</h1>
        <h1>Reporte de Canceladas del ".$this->input->post('fecha_inicial')." al ".$this->input->post('fecha_final')."</h1>
        <table id=\"hor-minimalist-b\">
        <caption>Mostrando ".$query->num_rows()." Resultados</caption>
        <thead>
        ...
        $tabla.= anchor('recepcion/canceladas_excel/'.$this->input->post('fecha_inicial').'/'.$this->input->post('fecha_final'), 'Bajarlo a excel');
...
left join prendas p2 on a.prenda_nueva = p2.id
 where date(a.fecha) between ? and ?;";
        ...
        $tabla= "
        <h1>".TITULO_WEB."</h1>
        <h1>Reporte de Auditoria de Servicios ".$this->input->post('fecha_inicial')." al ".$this->input->post('fecha_final')."</h1>
        <table id=\"hor-minimalist-b\">
        <caption>Mostrando ".$query->num_rows()." Resultados</caption>
        <thead>
        ...
        $tabla.= anchor('recepcion/servicios_excel/'.$this->input->post('fecha_inicial').'/'.$this->input->post('fecha_final'), 'Bajarlo a excel');
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function create_member_orden_c()
    {
        ...
        if($q->num_rows() > 0){
            ...
            $this->db->set('fecha_entrega', 'date_add(date(now()), interval '.$this->dias.' day)', false);
