...
//************************************************************************************************************************* 
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////<br />   
    ...
    public function ordenes($estatus)
	{
       ...
       $data['ordenes'] = $this->recepcion_model->ordenes($estatus, $config['per_page'], $this->uri->segment(4));
       $data['titulo'] = "ORDENES";
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////<br />
    ...
    {
        $this->load->model('recepcion_model');
        echo $this->recepcion_model->detalle_sin_orden($this->input->post('id'), $this->input->post('descuento'));
    }

    function agrega_servicio()
    {
        $this->load->model('recepcion_model');
        echo $this->recepcion_model->agrega_servicio($this->input->post('id'), $this->input->get_post('servicio'), $this->input->get_post('cantidad'), $this->input->post('descuento'));
    ...
    {
        $this->load->model('recepcion_model');
        echo $this->recepcion_model->borra_servicio_sin_orden($this->input->get_post('id'), $this->input->post('descuento'), $this->input->get_post('id_orden'));
    ...
    {
        $this->load->model('recepcion_model');
        echo $this->recepcion_model->agrega_abono($this->input->post('id'), $this->input->get_post('tipo_pago'), $this->input->post('abono'));
    ...
    public function ventas_excel($fecha_inicial, $fecha_final, $estatus)
	{
	   $data = array();
       $this->load->model('recepcion_model');
       $data['query'] = $this->recepcion_model->ventas_excel($fecha_inicial, $fecha_final, $estatus);
       $data['titulo'] = "Reporte de Ventas";
       $data['f1'] = $fecha_inicial;
       $data['f2'] = $fecha_final;
    ...
    public function auditoria_excel($fecha_inicial, $fecha_final, $estatus, $usuario)
	{
	   $data = array();
       $this->load->model('recepcion_model');
       $data['query'] = $this->recepcion_model->auditoria_excel($fecha_inicial, $fecha_final, $estatus, $usuario);
